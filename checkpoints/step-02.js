...
// TODO 2a: CHANGE the code you wrote in step 1.
//   Delete the + version below and rebuild the same summary with a
//   TEMPLATE LITERAL (backticks). No more +.
//   Target output: "Superman the Kryptonian - HP 92, 42 rescues"
const painfulSummary = "HP: " + healthPoints + " Rescues: " + rescues;
console.log(painfulSummary);
